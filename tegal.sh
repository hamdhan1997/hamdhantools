...
echo
echo $cy"<════════════════════>"$pur" <══════════════>"
echo $me"█"$bi" ║ Author  : ║ HACKER CYBER TEAM TEGAL    ║      "$me"          █"
echo $ku"█"$bi" ║ WhatsApp: ║ 0856-4221-5xxx║"$ku"            █"
echo $bi"█"$bi" ║Gmail    : ║ hamdhansobirin713@gmail.com║"$bi"    █"
echo $i"█"$bi"  ║Youtube  : ║ HAMDHAN TUTORIAL║"$i"             █"
echo $me"<════════════════════>"$ku" <═══════════════>"
echo
...
echo $i"Terimakasih mas bro wis mampir nggo tools kiye"
sleep 2
echo $i"Silahkan Mas Bro nganggo Tools Kiye semoga Bermanfaat"
sleep 2
echo $i"Nagggo sampean²"
sleep 2
echo $i"Mbokat Sampean Durung Ngarti Sampean bisa Takon2 Ning No Wa ku 0856-4221-5238"
echo $i"Melalui Via:"
sleep 2
echo $ku"Facebook :"$pur" MUHAMAD HAMDAN SOBIRIN"
echo $ku"YouTube  :"$pur" HAMDAN TUTORIAL"
echo $ku"WhatsApp :"$pur" 0856-4221-5xxx"
sleep 2
echo $i"dan jangan lupa "$cy" LIKE SHARE AND SUBSCRIBE"
sleep 2
echo $i"Video Channel "$cy" hamdan tutorial"
sleep 2
echo $i"Agar tambah semangat Upload Video²"
sleep 2
echo $i"Di tonton Vidio anyare "
echo $i"Monggo Mas Bro aktifna juga  Tombol Loncenge"
sleep 2
echo $i"Eben ana pemberitahuane Video²"
echo $i"selanjute dari saya OKE"
sleep 2
echo
